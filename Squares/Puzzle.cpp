        ...
        Entity(sprite, size, boundingBox, pos) {
            ...
            for(int row = 0; row < gridSize; row += fractalSize) {
                for(int col = 0; col < gridSize; col += fractalSize) {
                    ...
                    m_Fractals.emplace_back(new Fractal(elements, {col, row}, glm::vec2(startCoords.x, startCoords.y)));
                }
            }
        }
...
void Puzzle::SplitFractal(Fractal* fractal) {
    ...
    Fractal* fractal0 = new Fractal(elements, {index.x, index.y}, glm::vec2(startCoords0.x, startCoords0.y));
    Fractal* fractal1 = new Fractal(elements, {index.x + 1, index.y}, glm::vec2(startCoords1.x, startCoords1.y));
    Fractal* fractal2 = new Fractal(elements, {index.x, index.y + 1}, glm::vec2(startCoords2.x, startCoords2.y));
    Fractal* fractal3 = new Fractal(elements, {index.x + 1, index.y + 1}, glm::vec2(startCoords3.x, startCoords3.y));
